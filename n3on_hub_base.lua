...
@@ -137,15 +99,18 @@ listLayout.SortOrder = Enum.SortOrder.LayoutOrder
...
@@ -179,12 +149,14 @@ local function LoadHome()
...
@@ -198,466 +170,540 @@ local function GetHum()
end
